...
BIRTH_RULES_TEXT = (
    ...
    "Береги {pronoun_acc} 🙂")
RESTORE_AMOUNT = {
    "hunger": 30, "toilet": 50, "sleep_need": 45, "hygiene": 40,
    "mood": 25, "attention": 20, "heal": 25, "jerk": 15}
ACTION_COOLDOWNS = {
    "hunger": 3600, "toilet": 900, "sleep_need": 7200, "hygiene": 5400,
    "mood": 1800, "attention": 1200, "heal": 3600, "jerk": 600}
ACTION_SPAM_LIMITS = {
    "hunger": 8, "toilet": 12, "sleep_need": 8, "hygiene": 8,
...
ACTION_DEATH_PHRASES = {
    ...
    "jerk": "💦 {name} дрочил(а) без остановки. Сердце не выдержало, рука застыла в трусах. На лице — блаженная улыбка.",
    "heal": "💊 {name} проглотил(а) слишком много таблеток. Печень отказала, кожа пожелтела. Судороги 20 минут — и тишина.",
    "toilet": "🚽 {name} слишком много бегал(а) в туалет. Обезвоживание, отказ почек. Умер(ла) на унитазе.",
    "sleep_need": "😴 {name} слишком много спал(а). Мозг атрофировался, дыхание остановилось во сне.",
    "hygiene": "🛁 {name} слишком часто мылся(ась). Кожа слезла пластами, сепсис. Умер(ла) в ванне.",
    "mood": "🙂 {name} играл(а) слишком долго. Эпилептический припадок. Умер(ла) с улыбкой на лице.",
    "attention": "🫂 {name} замучил(а) вниманием. Психика сломалась. Умер(ла) от травмы черепа."}
...
KILL_METHODS = [
    ...
    "🔥 Жечь по частям: сначала руки, потом ноги, потом лицо",
...
KILL_PHRASES = {
    ...
    "🪚 Распилить пополам пилой": "Пила вошла в пах и пошла вверх. {name} кричал(а), пока не дошло до грудной клетки. Внутри — пульсирующие кишки.",
    "🦴 Переломать все кости по одной": "Молоток стучал по коленям. Потом локти. Потом рёбра. {name} слышал(а), как хрустит собственный скелет.",
    "🪓 Отрубить конечности по одной": "Топор по левой руке — Хрусть! Отрубили вторую. Потом ноги. Кричал(а), пока не потерял(а) сознание.",
    "🔪 Снять кожу как с кролика": "Кожу снимали медленно. Сначала лицо, потом грудь. К концу {name} — обнажённое мясо.",
    "👁️ Выколоть глаза ложкой": "Ложка вошла в глазницу с мокрым хрустом. Глаз выскочил с куском нерва. {name} видел(а) последним глазом, как ложку подносят снова.",
    "🦷 Вырвать все зубы плоскогубцами": "32 зуба. Один за другим. Кровь льётся из разорванных дёсен.",
    "🧠 Просверлить череп и вытащить мозг": "Сверло вошло в висок со скрипом. {name} ещё дёргался(ась), когда ложка зачерпнула серое вещество.",
    "🩸 Слить всю кровь через надрезы": "Надрезы на руках и ногах. {name} смотрел(а), как жизнь вытекает в таз. В тазу — 5 литров крови.",
    "🪡 Зашить рот и глаза, оставить умирать": "{name} проснулся(ась) с зашитым ртом и зашитыми глазами. Умирал(а) 3 дня.",
    "⚰️ Похоронить заживо в гробу с трупами": "{name} проснулся(ась) в темноте, в обнимку с разложившимися телами. Червь заполз в ухо.",
    "🪦 Закопать по шею и оставить ворону выклевать глаза": "Первая ворона села на голову через 2 часа. {name} не мог(ла) моргнуть.",
    "⚰️ Заживо в гроб и закопать в землю": "{name} проснулся(ась) уже под землёй. Задохнулся(ась) через 2 дня.",
    "🧪 Впрыснуть кислоту в вены": "Кислота поднялась по венам к сердцу. Кожа пошла волдырями. Кричал(а) 4 минуты.",
    "👞 Утопить в бочке с кислотой": "{name} опускали в кислоту медленно. Кожа растворялась первой.",
    "🔥 Сжечь заживо в печи": "{name} чувствовал(а), как кожа пузырится. Пахло жареным мясом.",
    "🐁 Скормить крысам живьём в подвале": "Крысы начали с пальцев. {name} был(а) в сознании, когда доедали лицо.",
    "🪱 Засунуть червей в открытые раны": "Черви начали есть {name} изнутри. Прошли в живот через раны.",
    "🪤 Привязать к муравейнику и обмазать мёдом": "Муравьи начали с глаз. {name} был(а) в сознании 8 часов, пока его ели заживо.",
    "🐍 Запихнуть в мешок со змеями": "В темноте {name} чувствовал(а) только кольца и укусы. Яд разошёлся за 20 минут.",
    "🧊 Оставить в морге на неделю среди трупов": "На 3-й день {name} услышал(а), как сосед-труп зашевелился. На 5-й начал(а) есть чужие трупы.",
    "🩻 Раздавить прессом медленно": "Пресс опускался по миллиметру. Сначала хрустнули пальцы. Потом ноги. {name} видел(а) свои внутренности через рот.",
    "🕸️ Подвесить на крюки как в мясной лавке": "Крюки вошли под рёбра с хрустом. {name} висел(а) как туша. Кровь капала на пол 4 часа.",
    "🩹 Завязать глаза и слушать, как убивают родных": "{name} слышал(а) крики тех, кого любил(а). Умер(ла) от разрыва сердца.",
    "⚡ Подключить к трансформатору и повышать напряжение": "Сначала дёргались пальцы. Потом руки. {name} обуглился(ась) изнутри. Кожа почернела, из ушей пошёл дым.",
    "🔗 Приковать к батарее и оставить умирать от жажды": "На 4-й день {name} начал(а) пить собственную мочу. На 6-й — грыз(ла) свои пальцы. На 7-й — умер(ла).",
    "🪓 Рубить по пальцу в час, пока не дойдёт до головы": "10 часов. 10 пальцев. Психика сломалась на 3-м пальце. К концу — без пальцев, ещё живой(ая).",
    "🩸 Подвесить вниз головой и перерезать горло": "Кровь потекла в лицо {name}. Захлёбывался(ась) кровью, пока не потемнело в глазах.",
    "🧟 Запереть с обезумевшим от голода": "Через 3 дня {name} услышал(а) скребок по полу. Это был(а) не крыса. Каннибал начал с ног.",
    "🕳️ Скинуть в яму с кольями": "{name} упал(а) на колья животом. Умирал(а) медленно. Вороны начали с живота, ещё дышащего.",
    "🪞 Скальпировать и заставить надеть скальп как шапку": "{name} чувствовал(а), как кожа снимается, потом надевается обратно. Умер(ла) от шока.",
    "🌊 Утопить в реке с камнем на шее": "Камень потянул вниз. {name} смотрел(а) вверх на удаляющийся свет. В лёгкие хлынула вода.",
    "🚗 Переехать машиной насмерть": "Хруст костей под колёсами. {name} раздавлен(а) в лепёшку. Кишки вылезли через рот.",
    "💊 Отравить крысиным ядом": "Яд начал разъедать желудок. {name} блевал(а) кровью 6 часов. На вскрытии — каша из органов.",
    "☠️ Повесить на верёвке": "Верёвка натянулась. {name} дёргался(ась) 3 минуты, обмочился(ась). Лицо почернело, язык вывалился.",
    "🔫 Расстрелять в затылок": "Выстрел. Череп разлетелся. {name} упал(а) лицом вперёд. Мозг на стене.",
    "🫕 Сварить заживо в кипящей воде": "Кипяток хлынул на кожу. {name} визжал(а), пока не сварились лёгкие. Кожа слезла лохмотьями.",
    "🍳 Жарить заживо на сковороде": "{name} привязали к раскалённой сковороде. Спина зашипела. Мясо отваливалось от костей. Пахло шашлыком.",
    "🔥 Полить бензином и поджечь": "Бензин залили в рот и подожгли. {name} бегал(а) как факел, жир капал на пол. Обуглился(ась) стоя.",
    "🕯️ Поджаривать медленно на вертеле": "{name} насадили на вертел и вращали над огнём. Кричал(а) 3 часа, пока не запеклись внутренности.",
    "🍖 Полить кипящим маслом с ног до головы": "Масло хлынуло на {name}. Кожа пузырилась и слазила пластами. Орал(а), пока не сорвал(а) голос.",
    "🧂 Снять кожу и посыпать раны солью": "С {name} сняли кожу с ног до головы, потом посыпали солью. Кричал(а), пока не сорвал(а) связки.",
    "🍋 Снять кожу и полить лимонным соком": "Кожу сняли, потом выжали лимон прямо на мясо. {name} выл(а) как зверь. Умер(ла) через 15 минут.",
    "🪥 Расчесать лицо металлической щёткой до кости": "Щётка шла по лицу туда-сюда. Сначала кожа, потом мясо, потом кость. Глаза вытекли.",
    "🦷 Вырвать челюсть голыми руками": "Пальцы вошли в рот и схватили челюсть. Рывок — кость хрустнула. {name} захлёбывался(ась) кровью.",
    "👅 Вырвать язык плоскогубцами через горло": "Плоскогубцы схватили язык у корня. Медленно тянули, пока не оторвался. {name} булькал(а) кровью.",
    "👂 Отрезать уши и скормить ему же": "Уши отрезали ножницами. Потом засунули в рот и заставили проглотить. Умер(ла) от удушья.",
    "👃 Отрезать нос и зашить в задницу": "Нос отрезали и зашили в анус. Каждый туалет — ад. Умер(ла) через 3 дня от сепсиса.",
    "🩸 Вскрыть вены и смотреть как течёт кровь": "{name} разрезали вены и заставили смотреть. Кровь текла в таз. Умер(ла) с открытыми глазами.",
    "🩻 Раздавить грудную клетку коленом до хруста": "Колено опустилось на грудь. Рёбра хрустнули как сухие ветки. Кость проткнула лёгкое.",
    "🫀 Вытащить сердце через задний проход": "Руку засунули через задницу, прорвали диафрагму, схватили сердце. Вырвали с корнем.",
    "🧠 Забить мозг ложкой через глазницу": "Ложка вошла через глаз и разбила мозг в кашу. Из глазницы потекла серая жижа.",
    "🔨 Разбить череп молотком и посмотреть внутрь": "Молоток разнёс череп как яйцо. Кости в стороны, мозг вывалился на пол.",
    "🪚 Распилить вдоль позвоночника на живую": "Пила вошла в позвоночник и пошла вниз. Тело развалилось на две половины.",
    "🏺 Замуровать в бочке и утопить в реке": "{name} замуровали в бочке по шею и бросили в реку. Кричал(а) 4 минуты, потом булькнул(а).",
    "🐖 Скормить свиньям живым во дворе": "Свиньи накинулись всей толпой. Одна откусила руку, другая вцепилась в живот.",
    "🐕 Скормить голодным собакам живым": "Голодные псы разорвали {name} за минуту. Один отгрыз лицо, другой жрал кишки.",
    "🐊 Скормить крокодилам живым": "Крокодил схватил за ногу и утащил под воду. Нога оторвалась. Потом вторая.",
    "🦁 Скормить львам живым": "Львица схватила за шею. Лев начал с живота — вырвал внутренности и жрал тёплыми.",
    "🐻 Скормить медведю живым": "Медведь раздавил лапой, потом жрал с головы. Хруст черепа — вылизывает мозг.",
    "🦈 Скормить акулам живым": "{name} сбросили в воду с кровью. Первая акула откусила ногу, вторая — руку.",
    "🧟 Скормить каннибалу живым": "Каннибал начал с пальцев — откусывал по одному. Потом вскрыл(а) живот и жрал кишки сырыми.",
    "🕷️ Опустить в паутину с пауками": "Пауки начали кусать сразу. Яд разошёлся по телу. Паучата вылезли из тела.",
    "🦂 Запихнуть в яму со скорпионами": "Скорпионы жалили со всех сторон. Тело распухло. Орал(а) 2 часа, пока не отказали почки.",
    "🐜 Привязать голым к муравейнику": "Муравьи начали с глаз и паха. {name} был(а) в сознании 12 часов, пока ели живьём.",
    "🪡 Зашить все дырки и надуть до разрыва": "Все отверстия зашили, начали качать воздух. Кожа натянулась, потом лопнула с мокрым треском.",
    "🍼 Накачать воздух в вену шприцем": "Воздух попал в кровь. {name} схватился(ась) за грудь. Эмболия — сердце встало через 30 секунд.",
    "🩸 Выкачать всю кровь через шприц": "Иглу вставили в вену, начали тянуть поршень. Через 15 шприцов потерял(а) сознание. Откачали 5 литров.",
    "🦴 Выломать руки из суставов": "Руки выкручивали за спину, пока суставы не выскочили. Плечи вылезли через кожу.",
    "🦵 Отрезать ноги и заставить ползти": "Отрезали ноги по колено и заставили ползти. Умер(ла) через 4 часа от потери крови.",
    "🗡️ Снять скальп живьём и надеть ему же": "Скальп отрезали по кругу. Кожа отошла с мокрым звуком. Надели обратно на череп.",
    "🪝 Подвесить за ребро на мясной крюк": "Крюк вошёл под ребро с хрустом. Кровь стекала по ногам. Умирал(а) 6 часов.",
    "🚿 Ошпарить кипятком и снять кожу руками": "Кипяток хлынул, кожа сразу пошла пузырями. Потом её снимали руками пластами.",
    "🪨 Разбить лицо камнем до месива": "Камень бил по лицу снова и снова. Глаз вылетел, зубы в стороны. Через 20 ударов — кровавая каша.",
    "🪣 Засунуть голову в ведро с кислотой": "Голову окунули в кислоту по шею. Лицо растворилось за минуту. Булькал(а) и махал(а) руками.",
    "🕳️ Замуровать в стену живьём на месяц": "Заложили кирпичами в нишу. Ни пить, ни есть, ни двигаться. Умер(ла) через 12 дней, обглодав(а) пальцы.",
    "🍽️ Разделать как свинью и скормить семье": "{name} убили на глазах семьи, разделали и скормили родным. Мать ела, не зная.",
    "🐀 Засунуть в мешок с голодными крысами": "Крысы грызли изнутри всю ночь. Утром вытряхнули — скелет с остатками мяса.",
    "🧯 Сжечь кожу паяльной лампой по частям": "Пламя шло по коже участками. Сначала руки, потом ноги, потом лицо. Кожа стекала как воск.",
    "🩹 Завернуть в колючую проволоку и катать по полу": "Проволока вспарывала кожу до кости. Каждый оборот — новый порез. Умер(ла) через 2 часа.",
    "💉 Ввести формалин в мышцы пока не окаменеет": "Формалин вводили в мышцы. Тело твердело. Был(а) в сознании, но не мог(ла) пошевелиться.",
    "🪚 Пилить по живому от паха до горла": "Пила вошла в пах и медленно пошла вверх. {name} кричал(а), пока не порвались голосовые связки. Кишки вывалились на пол, сердце ещё билось.",
    "🔨 Раздробить таз кувалдой": "Кувалда опустилась на таз. Хруст ломающихся костей. {name} дёргался(ась), но не мог(ла) двигаться. Умер(ла) от болевого шока.",
    "🩸 Вскрыть грудную клетку и рвать лёгкие руками": "Рёбра развели крючьями. Лёгкие пульсировали на виду. Руки вошли внутрь и начали рвать их на куски. Захлёбывался(ась) кровью изнутри.",
    "🫀 Засунуть руку в грудь и вырвать сердце": "Рука прошла между рёбер, схватила сердце и рванула. {name} был(а) в сознании 15 секунд и видел(а) своё сердце в чужой руке.",
    "🦷 Отгрызать пальцы по одному зубами": "Зубы впились в палец {name} и отгрызли по фаланге. Потом следующий. Орал(а), пока не отгрызли все десять.",
    "🪡 Зашить глаза проволокой": "Иглу с проволокой продели через глаз и зашили. Потом второй. Ослеп, кричит, пытается выцарапать проволоку ногтями.",
    "🐁 Натравить стаю крыс на голое тело": "Голого {name} облили кровью и выпустили крыс. Начали с глаз и паха. Умер(ла), когда крысы добрались до горла.",
    "🪱 Залить в горло червей и завязать рот": "{name} разжали челюсть и залили банку червей. Рот зашили. Черви полезли в нос, уши, лёгкие. Задыхался(ась) и чувствовал(а), как они шевелятся внутри.",
    "🔥 Жечь по частям: сначала руки, потом ноги, потом лицо": "Горелку поднесли к рукам {name}. Кожа пузырилась и стекала. Потом ноги. Потом лицо. Обуглился(ась) по кускам, ещё живой(ая).",
    "🧪 Заливать кислоту в уши и глаза": "Кислоту заливали шприцем в уши. Потом в глаза. Мозг начал растворяться. Умер(ла) через 30 минут, с дымящимися глазницами.",
    "🩹 Медленно срезать половые органы": "Скальпель медленно отрезал всё. По кусочку, чтобы не умер(ла) от шока. Смотрел(а), как от него отрезают части.",
    "🪓 Отрубить руки и забить ими до смерти": "Руки отрубили топором. Потом этими же руками начали бить по лицу. Умер(ла) от травмы черепа собственными руками.",
    "🪝 Подвесить за кожу на спине": "Крюки вошли под кожу спины. Кожа натянулась и начала рваться по кускам. Через 4 часа висел(а) на кусках мяса, ещё дыша.",
    "🦴 Выломать рёбра и вытащить лёгкие через спину": "Рёбра выломали по одному. Потом пробили спину и вытащили лёгкие. Смотрел(а), как его лёгкие держат в руке.",
    "🗡️ Вскрыть живот и вытащить кишки на его же глазах": "Живот вскрыли ножом. Кишки вытащили наружу. Смотрел(а) на свои внутренности в чужой руке. Умер(ла) от перитонита.",
    "🐜 Зашить в мешок с муравьями и повесить": "{name} зашили в мешок с миллионом муравьёв. Кусали везде: глаза, пах, рот. Потом подвесили. Кричал(а) 12 часов.",
    "💉 Впрыснуть воздух в сердце": "Шприц вошёл прямо в сердце. Воздух попал в сосуды. Глаза вылезли из орбит. Эмболия — сердце встало через 10 секунд.",
    "🧯 Выжечь глаза паяльной лампой": "Пламя ударило прямо в глаза. Влага закипела, глазные яблоки лопнули. Орал(а) и пытался(ась) прикрыть лицо руками.",
    "🪚 Спилить челюсть вручную": "Пилой отпиливали челюсть по кусочкам. Сначала нижнюю. Пытался(ась) кричать, но язык болтался. Потом верхнюю.",
    "👁️ Зашить глаза изнутри": "Иглу провели через глазное яблоко изнутри и вывели наружу. Чувствовал(а), как нить тянет внутри глаз. Полностью ослеп.",
    "🩸 Выпустить кровь в ванну и утопить в ней": "Вены вскрыли над ванной. Кровь текла 40 минут. Когда ванна наполнилась — голову окунули в его же кровь.",
    "🍽️ Скормить собственные конечности": "Руки и ноги отрубили и поджарили. Потом засунули в рот и заставили есть. Давился(ась) собственной плотью.",
    "🪣 Засунуть голову в чан с кипящей смолой": "Смола закипела. Голову окунули по шею. Кожа лица слезла за секунду. Мозг вскипел.",
    "🪨 Раздробить пальцы камнем один за другим": "Камень опускался на палец. Хруст. Потом следующий. Все десять. Потом молотком по кистям.",
    "🪝 Крюк через язык и подвесить": "Крюк пробил язык насквозь. Подвесили, держась за язык. Язык начал рваться. Когда порвался — упал(а), захлёбываясь кровью.",
    "🔨 Вбивать гвозди в череп молотком": "Первый гвоздь вошёл в висок. Второй — с другой стороны. Потом в затылок. 20 гвоздей. Мозг превратился в кашу.",
    "🩹 Снять кожу и натереть солью и перцем": "С {name} сняли кожу как с кролика. Потом натёрли солью и красным перцем. Орал(а) так, что порвал(а) связки.",
}
...
def init_db():
    with get_db() as conn:
        with conn.cursor() as cur:
            ...
            for sql in [
                "ALTER TABLE chat_settings ADD COLUMN IF NOT EXISTS owner_id BIGINT NOT NULL DEFAULT 0",
                "ALTER TABLE substitutions ADD COLUMN IF NOT EXISTS owner_id BIGINT NOT NULL DEFAULT 0"]:
                try: cur.execute(sql)
                except: pass
            ...
            try:
                ...
                if m_birth:
                    ...
                    if any(k["name"].lower() == nm.lower() for k in kids):
                        ...
                        sp = get_spouse(cid, user_id); spouse_id = None
                        if sp:
...
async def _give_birth(message: Message):
    ...
    sp = get_spouse(chat_id, owner_id); spouse_id = None
    if sp:
...
async def cb_media(callback: CallbackQuery):
    ...
    total = len(all_media)
    if total == 0:
        await callback.answer("📭 Медиа нет в базе. Нажми «🔄 Загрузить историю».", show_alert=True); return
        ...
        try:
            if media_file_id:
                try:
                    ...
                    logging.warning(f"file_id fail {msg_id}: {tbe}")
            ...
            if client:
                ...
                try:
                    ...
                    await callback.message.answer(f"⚠️ #{msg_id} слишком большой.", parse_mode="HTML")
                try: os.remove(path)
                except: pass
...
async def process_callbacks(callback: CallbackQuery, state: FSMContext):
    ...
    if data.startswith("opnch_"):
        ...
        if total == 0:
            ...
            if client:
                ...
                text = (f"💬 <b>Чат:</b> {cid}\n\n"
                        f"<i>Сообщений нет. Если чат только через Business-бота — "
                        f"они начнут сохраняться с момента подключения.</i>")
    ...
    if data.startswith("bfchat_"):
        ...
        if not client:
            await callback.answer("ℹ️ Нет Telethon-сессии. Без номера телефона историю подтянуть нельзя.", show_alert=True)
            return
        await callback.answer("⏳", show_alert=False)
